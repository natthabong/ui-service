...
public class SponsorConfigController {
	...
	private static String VIEW_IMPORT_CHANNEL = "sponsor-configuration/import-channels/view";
	private static String VIEW_IMPORT_CHANNEL_FTP = "sponsor-configuration/import-channels/ftp-view";
	private static String VIEW_EXPORT_CHANNEL_FTP = "sponsor-configuration/export-channels/ftp-view";
	...
	public String exportChannelSetup(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String paymentAmountFormula(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String viewExportChannelFTP(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String viewImportChannel(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String viewImportChannelFTP(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String viewDocumentDisplay(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
	...
	public String viewCreateTransactionDisplay(
			@RequestHeader("X-Requested-With") String requestedWith) {
		if (AjaxUtils.isAjaxRequest(requestedWith)) {
