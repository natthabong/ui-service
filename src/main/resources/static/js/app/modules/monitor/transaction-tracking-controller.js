		...
		vm.dataTable = {
			...
			columns : [
				...
				},
				{
					...
					sortable : false,
					cellTemplate : '<scf-button ng-disabled="data.detail" class="btn-default gec-btn-action" id="{{data.$rowNo}}-view-button" ng-click="ctrl.viewMessage(data)" title="View"><i class="fa fa-search" aria-hidden="true"></i></scf-button>'
				} ]
		}
