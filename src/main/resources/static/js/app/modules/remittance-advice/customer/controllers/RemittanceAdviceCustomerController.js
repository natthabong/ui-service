...
raccModule.controller('RemittanceAdviceCustomerController', [
	...
	'SCFCommonService',
	'UIFactory',
	function ($http, $q, $rootScope, $scope, $stateParams, blockUI, PagingController, RemittanceAdviceCustomerService, SCFCommonService, UIFactory) {
		var vm = this;
		...
		vm.searchRemittanceAdvice = function(pageModel) {
			...
			if (dateFrom != '' &&  dateFrom != null && dateTo != '' && dateTo != null){
				...
				if(dateTimeFrom > dateTimeTo){
					vm.invalidDateCriteria = true;
					vm.invalidDateCriteriaMsg = {
	                    message : 'From Date must be on the same day or before To Date.'
	                }
				}
			}
...
//			});
		...
		var initLoad = function() {
			vm.showBuyer = true;
			vm.toggleSupplierSearch = true;
			vm.toggleBuyerSearch = true;
