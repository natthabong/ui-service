'use strict';
angular.module('gecscf.supplierCreditInformation').controller('ViewSupplierCreditInformationController', [
	'$filter',
	'$stateParams',
	'PagingController',
	'UIFactory',
	'scfFactory',
	function ($filter, $stateParams, PagingController, UIFactory, scfFactory) {
		var vm = this;
		var _criteria = {};
		var accountTypes = {
			"LOAN": "Term loan",
