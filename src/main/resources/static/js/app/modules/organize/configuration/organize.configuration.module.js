...
angular
  .module(
    'gecscf.organize.configuration', ['ui.router', 'scfApp', 'gecscf.ui',
    ...
    [
      ...
      function ($stateProvider) {
        var requiredModules = [
          ...
          'js/app/modules/organize/configuration/channel/import/controllers/TestConnectionResultController.js',
        ...
        $stateProvider
          ...
          .state(
            '/sponsor-configuration/file-layouts/new-file-layout', {
            ...
            .state(
            '/sponsor-configuration/file-layouts/view-file-layout', {
