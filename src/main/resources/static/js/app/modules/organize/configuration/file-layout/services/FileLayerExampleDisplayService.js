'use strict';
angular.module('gecscf.organize.configuration.fileLayout').factory('FileLayerExampleDisplayService', ['$filter', function ($filter) {
	...
	function DATE_TIME_DisplayExample(record, config) {
		...
		var calendarEra = "Gregorian calendar (A.D.)";
