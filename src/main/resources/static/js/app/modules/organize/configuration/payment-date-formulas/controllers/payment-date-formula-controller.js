...
app.controller('PaymentDateFormulaController', [
    'SCFCommonService',
    '$log',
    '$scope',
    '$stateParams',
    ...
    '$q',
    '$http',
    function (SCFCommonService, $log, $scope, $stateParams, $timeout, ngDialog, PageNavigation, Service, UIFactory, $q, $http) {
        var vm = this;
        var log = $log;
        ...
        vm.dataTable = {
            ...
            columns: [{
                ...
                sortData: false,
                cellTemplate: '<scf-button class="btn btn-sm" ng-disabled="ctrl.unauthenView() && ctrl.unauthenMangeAction()" id="payment-date-formula-{{data.formulaName}}-view-button" ng-click="ctrl.view(data)" title="View a payment date formula configs"><i class="fa fa-search" aria-hidden="true"></i></scf-button>' +
                    '<scf-button id="payment-date-formula-{{data.formulaName}}-setup-button" ng-disabled="ctrl.unauthenMangeAction()"  class="btn btn-sm" ng-click="ctrl.config(data)" title="Config a payment date formula configs"><i class="fa fa-cog" aria-hidden="true"></i></scf-button>' +
                    '<scf-button id="payment-date-formula-{{data.formulaName}}-delete-button" ng-disabled="ctrl.unauthenMangeAction()" class="btn btn-sm" ng-click="ctrl.deleteFormula(data)" title="Delete a payment date formula configs"><i class="fa fa-trash-o" aria-hidden="true"></i></scf-button>'
            }]
        };
...
app.controller('NewPaymentDateFormulaController', [
    '$scope',
    '$rootScope',
    'Service',
    'PaymentDateFormulaService',
    'ngDialog',
    'UIFactory',
    function ($scope, $rootScope, Service, PaymentDateFormulaService, ngDialog, UIFactory) {
        var vm = this;
