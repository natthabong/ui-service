	...
	[
		...
		function ($scope, Service, $stateParams, $log,
			...
			function _storeCriteria() {
				...
				angular.copy(vm.userListModel, _userListModel);
			}
			...
			vm.newUser = function () {
				...
				PageNavigation.nextStep('/user/new', params, { criteria: _criteria, userListModel: _userListModel });
			}
			...
			vm.viewUser = function (data) {
				...
				$timeout(function () {
					PageNavigation.nextStep('/user/view', params, { criteria: _criteria, userListModel: _userListModel });
				}, 10);
			}
			...
			vm.editUser = function (data) {
				...
				$timeout(function () {
					PageNavigation.nextStep('/user/edit', params, { criteria: _criteria, userListModel: _userListModel });
				}, 10);
			}
