	    ...
	    vm.dataTable = {
            ...
            columns: [{
				...
				cellTemplate : 	'<scf-button ng-disabled="false" class="btn-default gec-btn-action" id="view-button-{{data.userId}}" ng-click="ctrl.viewUser(data)" title="View"><i class="fa fa-search" aria-hidden="true"></i></scf-button>'+
								'<scf-button ng-disabled="false" class="btn-default gec-btn-action" id="reset-password-button-{{data.userId}}" ng-click="ctrl.resetPasswordUser(data)" title="Reset password"><i class="fa fa-unlock-alt" aria-hidden="true"></i></scf-button>'+
