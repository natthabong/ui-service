...
scfApp.controller('DocumentListController', [
    '$http',
    '$log',
    '$q',
    '$rootScope',
    ...
    'UIFactory',
    'scfFactory',
    function ($http, $log, $q, $rootScope, $scope, $stateParams, DocumentListStatus, PagingController, SCFCommonService, Service, UIFactory, scfFactory) {
        var vm = this;
        ...
        deferred.promise.then(function (response) {
            ...
            vm.documentStatusDropdowns = DocumentListStatus;
            ...
            vm.documentListModel = {
                ...
                documentStatus: vm.documentStatusDropdowns[0].value
            }
