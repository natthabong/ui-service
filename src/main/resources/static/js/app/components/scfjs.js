(function() {
	...
	// console.log('el', el[0]);
	// },
	// controller: ['Service', '$scope', '$transclude', function (Service,
	// $scope, $transclude) {
	//
	// var vm = $scope;
	//
	...
	// type="button" ng-click="scfPaginationAction(\'first\')" class="btn-sm"
	// id="first-page-button"><span class="glyphicon glyphicon-step-backward"
	// aria-hidden="true"></span></scf-button></li>' + '<li><scf-button
	// type="button" ng-click="scfPaginationAction(\'back\')" class="btn-sm"
	// id="back-page-button"><span class="glyphicon glyphicon-triangle-left"
	// aria-hidden="true"></span></scf-button></li>' + '<li><scf-dropdown
	// ng-model="pageSizeModel" ng-change="scfPaginationAction(\'changeSize\')"
	// component-data="pageSizeList"></scf-dropdown</li>' + '<li><button
	// type="button" ng-click="scfPaginationAction(\'next\')" class="btn
	// btn-default btn-sm" id="next-page-button"><span class="glyphicon
	// glyphicon-triangle-right" aria-hidden="true"></span></button></li>' +
	// '<li><button type="button" ng-click="scfPaginationAction(\'last\')"
	// class="btn btn-default btn-sm" id="last-page-button"><span
	// class="glyphicon glyphicon-step-forward"
	// aria-hidden="true"></span></button></li>' + '</ul>';
	// return template;
	// }
	// }])
...
//				var data = $filter('translate', scope.label);
//				scope.label = "FFF";
//				console.log(scope.label);
//			},
			controller : [ '$scope', function($scope) {
				$scope.model = $scope.$parent.ctrl.model;
//				var displayLabel = $scope.label;

				var hasColon = $scope.displayColon;
...
//					displayLabel = displayLabel + ":";
				...
				console.log(hasColon);
				$scope.displayColon = hasColon;
//				$scope.model[$scope.label] = displayLabel;
