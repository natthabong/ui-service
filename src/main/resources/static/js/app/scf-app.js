...
var app = angular.module('scfApp', ['pascalprecht.translate', 'ui.router', 'ui.bootstrap', 'ui.mask', 'authenApp', 'oc.lazyLoad', 'checklist-model', 'blockUI', 'scf-ui', 'ngDialog', 'nvd3ChartDirectives',
                        			'legendDirectives','chart.js', 'gecscf.ui', 'ngCookies', 'gecscf.profile', 'gecscf.user', 'gecscf.tradingPartner', 'gecscf.tradingPartner.financing'])
    .config(['$httpProvider', '$translateProvider', '$translatePartialLoaderProvider', '$stateProvider', '$locationProvider','blockUIConfig','$logProvider','$compileProvider','$urlRouterProvider','ngDialogProvider',
	    ...
	    $urlRouterProvider.otherwise('/dashboard');
			...
			.state('/verify-transaction', {
                ...
                params: {transactionModel: null, criteria: null, documentSelects: null, backAction: false},
                ...
                params: {mode:"BUYER",transactionModel: null, backAction: false},
			...
			}).state('/approve-payment/approve',{
				url: '/approve-payment/approve',
				controller: 'ApprovePaymentController',
				controllerAs: 'ctrl',
				templateUrl: '/payment/approve',
				params: {transaction: null},
				resolve: load(['js/app/modules/transaction/payment/services/ApprovePaymentService.js','js/app/modules/transaction/payment/services/ApprovePaymentController.js'])
			}).state('/error', {
				url: '/error',
